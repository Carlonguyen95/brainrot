...
import { signUp, signInWithSocial } from "@/lib/auth"
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Create an account to submit your own slang definitions</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="username" name="username" required placeholder="cooluser123" />
          </div>
          <div className="space-y-2">
