...
import EditDefinitionForm from "@/components/edit-definition-form"
    ...
    async function fetchDefinition() {
      ...
      try {
        ...
        if (data.user_id !== user.id) {
          setError("You don't have permission to edit this definition")
          setDefinition(null)
          return
        }
  ...
  if (definition) {
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-screen-xl mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto">
            <h1 className="text-2xl font-bold mb-6">Edit Definition: {definition.word}</h1>
